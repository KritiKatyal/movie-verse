...
const Anime_info = () => {
  ...
  return (
    <div className='transition-all bg-black dark:bg-black h-full overflow-x-hidden'>
      <div className='bg-black dark:bg-slate-800'>
        <div className='sm:pb-2 md:pb-10 xl:pb-2 pb-28'>
          <nav className="bg-purple-900 dark:teal-800 p-5 py-2.5 transition-all ease-in-out absolute w-full z-10">
            <div className="container flex flex-wrap justify-between items-center transition-all ease-in-out">
              ...
              <div className='flex w-full xl:w-2/4'>
                <div className="relative w-full transition-all ease-in-out rounded-xl px-6">
                  ...
                  <input type="text" id="search-navbar" onChange={handleChange} className="p-2 pl-10 w-full text-white rounded-xl outline-0 text-sm outline-none" placeholder="Search..." />
                </div>
                <button onAuxClick={handleThemeChange} id="theme-toggle" className="transition-all transform text-white dark:text-gray-400 bg-purple-900 dark:bg-gray-100 rounded-lg text-sm scale-125 p-1">
      ...
      {datas &&
        datas.map((records) => {
          return (
            ...
            <p className="font-bold text-xl leading-10 text-white">
