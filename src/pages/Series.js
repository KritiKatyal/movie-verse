                    ...
                    <div className='grid grid-cols-1 gap-8 p-12 xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 md:pt-24 pt-28 transition-all transform ease-in-out float-none'>
                        {
                            data && data.map((records) => {
                                ...
                                return (
                                    <div className="flex-wrap group shadow-xl hover:shadow-lg shadow-black rounded-3xl bg-pink-900 overflow-hidden hover:scale-110 duration-500 transition-all ease-in-out" key={ids}><p className='absolute group-hover:block hidden mt-36 mx-20 text-center mx-8 text-black font-extrabold text-lg'>{records.total_episode} Episodes</p>
